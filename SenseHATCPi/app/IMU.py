...
def read_sensors():
  ...
  try:
    ...
    qmitemp = imu.QMI8658_readTemp()
    tmparr = []
    tmparr.append(['Roll', str(roll)])
    tmparr.append(['Pitch', str(pitch)])
    tmparr.append(['Yaw', str(yaw)])
    tmparr.append(['Accel_X', str(Accel[0])])
    tmparr.append(['Accel_Y', str(Accel[1])])
    tmparr.append(['Accel_Z', str(Accel[2])])
    tmparr.append(['Gyro_X', str(Gyro[0])])
    tmparr.append(['Gyro_Y', str(Gyro[1])])
    tmparr.append(['Gyro_Z', str(Gyro[2])])
    tmparr.append(['Mag_X', str(Mag[0])])
    tmparr.append(['Mag_Y', str(Mag[1])])
    tmparr.append(['Mag_Z', str(Mag[2])])
    tmparr.append(['QMITemp', qmitemp])
    results['data'] = tmparr
